...
适用于 Google Vertex AI 平台的 LangChain 集成。

!!! note "Vertex AI 集成说明"

    自 `langchain-google-vertexai` 3.2.0 版本起，部分类已被弃用，并迁移至 `langchain-google-genai` 4.0.0 中的等效类，后者基于整合后的 [`google-genai`](https://googleapis.github.io/python-genai/) SDK。
